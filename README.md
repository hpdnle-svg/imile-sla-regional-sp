...
## V7.3 — Supervisor + múltiplas bases
...
## V7.3 — Integração Base → Motorista → AWB
...
## V7.3 — AWBs Pendentes otimizada para PNG
...
## V7.3 — Integração completa Supervisor → Bases → Motoristas → AWBs
...
## V7.3 — Contraste visual ampliado
...
- AWBs Pendentes ganhou filtro "O que deseja cobrar?".
- Opções: Em rota, Todos os pendentes, Não entregues e Status específico.
- Fluxo mantido: Supervisor → Base → Motorista → Tipo de cobrança/Status → AWBs.
...
- Textos sobre Azul Gelo usam azul-marinho para maior contraste.
- Abas e filtros foram clareados mantendo hierarquia visual.
- Tabelas receberam linhas claras e texto escuro.
- Semáforos de performance permanecem vermelho, amarelo e verde.
- A área de exportação PNG acompanha a nova identidade.


## V7.3 — Azul Gelo reforçado
...
- Tabelas receberam linhas claras e cabeçalhos em azul médio.
- Abas e filtros ficaram claros e destacados.
- Fundo geral continua azul iMile escuro para contraste.
- Semáforos vermelho/amarelo/verde foram preservados.


## V7.3 — Gráficos em azul escuro
...
- Títulos, eixos, legendas e grades foram clareados para maior contraste.
- O gráfico do Resumo por Base segue o mesmo padrão escuro.
