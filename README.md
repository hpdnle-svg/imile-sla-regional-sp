...
## V7.0 — Supervisor + múltiplas bases
...
## V7.0 — Integração Base → Motorista → AWB
...
## V7.0 — AWBs Pendentes otimizada para PNG
...
## V7.0 — Integração completa Supervisor → Bases → Motoristas → AWBs
...
## V7.0 — Contraste visual ampliado
