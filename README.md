...
## V7.2 — Supervisor + múltiplas bases
...
## V7.2 — Integração Base → Motorista → AWB
...
## V7.2 — AWBs Pendentes otimizada para PNG
...
## V7.2 — Integração completa Supervisor → Bases → Motoristas → AWBs
...
## V7.2 — Contraste visual ampliado
