...
## V7.1 — Supervisor + múltiplas bases
...
## V7.1 — Integração Base → Motorista → AWB
...
## V7.1 — AWBs Pendentes otimizada para PNG
...
## V7.1 — Integração completa Supervisor → Bases → Motoristas → AWBs
...
## V7.1 — Contraste visual ampliado
